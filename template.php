 ...
 * @see page.tpl.php
 */
function basass_preprocess_page(&$variables) {
 ...
 */
function basass_preprocess_maintenance_page(&$variables) {
 ...
 * @see layout.tpl.php
 */
function basass_preprocess_layout(&$variables) {
 ...
 * @see node.tpl.php
 */
function basass_preprocess_node(&$variables) {
 ...
 * @see header.tpl.php
 */
function basass_preprocess_header(&$variables) {
  $logo = $variables['logo'];
 ...
 */
function basass_breadcrumb($variables) {
